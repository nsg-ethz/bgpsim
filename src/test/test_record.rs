...
mod t {
    use crate::{
        ...
        types::{
            AsId, FwDelta, NetworkError, NonOverlappingPrefix, Prefix, RouterId, SimplePrefix,
            SinglePrefix,
        },
    };
    ...
    #[test]
    fn test_simple_deterministic<P: Prefix + NonOverlappingPrefix>() {

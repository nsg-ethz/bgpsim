...
pub fn migration_button() -> Html {
    ...
    let class = "rounded-full z-10 p-2 px-4 drop-shadow hover:drop-shadow-lg bg-white text-gray-700 hover:text-main pointer-events-auto ease-in-out duration-150 transition";
